  ...
  return (
    <div>
      ...
      <main className="container" style={{paddingTop:20}}>
        <div className="card">
          <h1>Medicines Delivery & Counselling</h1>
          <p className="caption">Details about Medicines Delivery & Counselling are coming soon. Meanwhile, contact us to discuss your needs and we will assist you personally.</p>
